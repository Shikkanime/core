...
class UpdateAnimeJobTest : AbstractTest() {
    ...
    fun `update Crunchyroll anime Date A Live`() {
        ...
        assertEquals(
            ...
            attachmentService.findByEntityUuidTypeAndActive(anime.uuid!!, ImageType.THUMBNAIL)?.url
        )
        assertEquals(
            "https://www.crunchyroll.com/imgsrv/display/thumbnail/1920x1080/catalog/crunchyroll/60db2c4acbf891c7ea5f2d7982c43163.jpg",
            attachmentService.findByEntityUuidTypeAndActive(anime.uuid, ImageType.BANNER)?.url
        )
        assertEquals(
    ...
    fun `update Crunchyroll anime KONOSUBA`() {
        ...
        assumeTrue("https://www.crunchyroll.com/imgsrv/display/thumbnail/1560x2340/catalog/crunchyroll/041fa9860f09efb08b3c8a3af712b985.jpg" == attachmentService.findByEntityUuidTypeAndActive(anime.uuid!!, ImageType.THUMBNAIL)?.url)
    ...
    fun `update ADN and Crunchyroll anime ONE PIECE Log Fish-Man Island Saga`() {
        ...
        assertEquals(
            "https://image.animationdigitalnetwork.com/license/onepiecefishmansaga/tv/web/affiche_1560x2340.jpg",
            attachmentService.findByEntityUuidTypeAndActive(anime.uuid!!, ImageType.THUMBNAIL)?.url
        )

        assertEquals(
            "https://image.animationdigitalnetwork.com/license/onepiecefishmansaga/tv/web/license_1920x1080.jpg",
            attachmentService.findByEntityUuidTypeAndActive(anime.uuid, ImageType.BANNER)?.url
        )
    ...
    fun `update DAN DA DAN on multiple platforms`() {
        ...
        assertEquals(
            "https://image.animationdigitalnetwork.com/license/dandadan/tv/web/affiche_1560x2340.jpg",
            attachmentService.findByEntityUuidTypeAndActive(anime.uuid!!, ImageType.THUMBNAIL)?.url
        )

        assertEquals(
            "https://image.animationdigitalnetwork.com/license/dandadan/tv/web/license_1920x1080.jpg",
            attachmentService.findByEntityUuidTypeAndActive(anime.uuid, ImageType.BANNER)?.url
        )
    ...
    fun `update ADN and Crunchyroll anime One Piece Fan Letter`() {
        ...
        assertEquals(
            "https://image.animationdigitalnetwork.com/license/onepiecefanletter/tv/web/affiche_1560x2340.jpg",
            attachmentService.findByEntityUuidTypeAndActive(anime.uuid!!, ImageType.THUMBNAIL)?.url
        )

        assertEquals(
            "https://image.animationdigitalnetwork.com/license/onepiecefanletter/tv/web/license_1920x1080.jpg",
            attachmentService.findByEntityUuidTypeAndActive(anime.uuid, ImageType.BANNER)?.url
        )
