    ...
    companion object {
        ...
        fun mediaTestCases(): Stream<MediaTestCase> = Stream.of(
            ...
            MediaTestCase(
                ...
                latestReleaseDateTime = ZonedDateTime.parse("2025-11-22T17:30:00Z"),
            ...
            MediaTestCase(
                ...
                firstReleasedYear = 2024,
                latestReleaseDateTime = ZonedDateTime.parse("2024-01-21T14:00:00Z"),
            ...
            MediaTestCase(
                ...
                latestReleaseDateTime = ZonedDateTime.parse("2005-09-28T15:00:00Z"),
                exceptedMediaId = 19
            ),
            MediaTestCase(
                ...
                firstReleasedYear = 2022,
                latestReleaseDateTime = ZonedDateTime.parse("2022-12-17T14:00:00Z"),
            ...
            MediaTestCase(
                ...
                latestReleaseDateTime = ZonedDateTime.parse("1982-05-05T16:00:00Z"),
            ...
            MediaTestCase(
                ...
                firstReleasedYear = 2023,
                latestReleaseDateTime = ZonedDateTime.parse("2024-02-02T07:00:00Z"),
            ...
            MediaTestCase(
                ...
                firstReleasedYear = 2023,
                latestReleaseDateTime = ZonedDateTime.parse("2023-06-24T09:31:00Z"),
            ...
            MediaTestCase(
                ...
                firstReleasedYear = 2023,
                latestReleaseDateTime = ZonedDateTime.parse("2023-03-10T07:00:00Z"),
                exceptedMediaId = 166038
            ),
            MediaTestCase(
                name = "Crusher Joe",
                firstReleasedYear = 1983,
                latestReleaseDateTime = ZonedDateTime.parse("1983-03-12T08:00:00Z"),
                exceptedMediaId = 2722
            ),
            MediaTestCase(
                name = "Moi, quand je me réincarne en Slime",
                firstReleasedYear = 2018,
                latestReleaseDateTime = ZonedDateTime.parse("2024-09-27T15:30:00Z"),
                exceptedMediaId = 101280
            ),
            MediaTestCase(
                name = "Yu-Gi-Oh The Dark Side of Dimensions",
                firstReleasedYear = 2016,
                latestReleaseDateTime = ZonedDateTime.parse("2016-04-23T13:15:00Z"),
            ...
            MediaTestCase(
                ...
                platforms = listOf(AnimePlatform(platform = Platform.CRUN, platformId = "G6MEK1ZGR")),
                firstReleasedYear = 2018,
                latestReleaseDateTime = ZonedDateTime.parse("2025-11-19T20:00:00Z"),
                exceptedMediaId = 100500
            ),
            MediaTestCase(
                ...
                firstReleasedYear = 2023,
                latestReleaseDateTime = ZonedDateTime.parse("2023-06-29T05:00:00Z"),
            ...
            MediaTestCase(
                ...
                firstReleasedYear = 2017,
                latestReleaseDateTime = ZonedDateTime.parse("2021-10-12T20:00:00Z"),
            ...
            MediaTestCase(
                ...
                firstReleasedYear = 2022,
                latestReleaseDateTime = ZonedDateTime.parse("2002-03-27T16:00:00Z"),
                exceptedMediaId = 263
            ),
            MediaTestCase(
                ...
                latestReleaseDateTime = ZonedDateTime.parse("2010-03-27T17:00:00Z"),
            ...
            MediaTestCase(
                ...
                firstReleasedYear = 2011,
                latestReleaseDateTime = ZonedDateTime.parse("2012-06-02T15:00:00Z"),
