...
import fr.shikkanime.utils.indexers.DeprecatedGroupedIndexer.Data
...
typealias ReverseIndexedRecord = Pair<IndexedDataEntry, DeprecatedGroupedIndexer.CompositeIndex>
typealias ReverseDataIndexRecord = Triple<Data, IndexedDataEntry, DeprecatedGroupedIndexer.CompositeIndex>

@Deprecated("Use the new indexer")
object DeprecatedGroupedIndexer {
