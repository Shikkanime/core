...
object TelemetryConfig {
    ...
    fun getTracer(name: String): Tracer {
        check (isInitialized) { "TelemetryConfig is not initialized" }
    ...
    fun <T> Tracer.spanWithAttributes(name: String? = null, fn: (Span) -> T): T {
    ...
    fun <T> Tracer.span(name: String? = null, fn: () -> T): T = spanWithAttributes(name) { _ -> fn() }
}