...
fun main(args: Array<String>) {
    ...
    ImageService.loadCache(animeService.findAllUuids(), episodeMappingService.findAllUuids(), memberService.findAllUuids())
    Thread { ImageService.addAll(async = false) }.start()
