...
enum class Platform(
    ...
    DISN("Disney+", "https://www.disneyplus.com/", "disneyplus.jpg", 2, true, "https://www.disneyplus.com/browse/entity-{ID}", true),
    NETF("Netflix", "https://www.netflix.com/", "netflix.jpg", 3, true, "https://www.netflix.com/title/{ID}", true),
    PRIM("Prime Video", "https://www.primevideo.com/", "prime_video.jpg", 4, true, "https://www.primevideo.com/detail/{ID}", true),
