...
<#macro display canonicalUrl="" openGraphImage="" margin=true>
    <@layout.main canonicalUrl="${canonicalUrl}" openGraphImage="${openGraphImage}">
        <header>
            <nav class="navbar navbar-expand-lg bg-black bg-opacity-75 bg-blur-2" data-bs-theme="dark">
        ...
        <main>
            <div class="callout d-flex">
                <div class="align-content-center"><b>NOUVEAU</b> : découvrez notre application !</div>

                <div class="d-flex flex-column flex-md-row ms-auto me-0 text-end">
                    <a href="#" class="me-md-2 mb-2">
                        <img src="/assets/img/google_play.png" width="120" alt="Google Play">
                    </a>
                    <a href="#">
                        <img src="/assets/img/apple_store.png" width="120" alt="Apple Store">
                    </a>
                </div>
            </div>

            <div class="text-white<#if margin> container-fluid px-md-5</#if>">
                <#nested 1>
            </div>
        </main>
                ...
                <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                    <div class="col-md-4 d-flex align-items-center">
                        <div>
                            <a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
                                <img loading="lazy" src="/assets/img/favicons/favicon-64x64.png" alt="Shikkanime" width="24" height="24">
                            </a>
                    ...
                    <div class="col-md-4">
                        <ul class="mt-3 mt-md-0 nav d-flex justify-content-end list-unstyled">
                            ...
                            <li class="me-3">
                                <a class="text-muted" href="https://bsky.app/profile/shikkanime.bsky.social" target="_blank" aria-label="Bluesky">
