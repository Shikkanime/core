...
<@navigation.display canonicalUrl="${baseUrl}/presentation">
    <div class="container mt-3">
        ...
        <p>Shikkanime est une plateforme <strong>gratuite et open source</strong> qui centralise et répertorie de
            manière <strong>automatique</strong> l'ensemble des liens vers les épisodes d'anime disponibles légalement
            sur les plateformes de streaming.</p>
        ...
        <ul>
            <li><strong>Système automatisé :</strong> Fini les informations obsolètes ! Notre plateforme se charge de
                parcourir continuellement les plateformes de streaming.
            </li>
            <li><strong>Open source :</strong> Contribuez à l'amélioration de Shikkanime en modifiant le code source
                selon vos besoins et envies, comblant ainsi un vide dans l'offre actuelle.
            </li>
        ...
        <ul>
            ...
            <li>Plateformes de streaming légales telles que : <strong>Animation Digital Network (ADN)</strong>, <strong>Crunchyroll</strong>,
                <strong>Disney+</strong>, <strong>Netflix</strong>, <strong>Prime Video</strong></li>
        </ul>
