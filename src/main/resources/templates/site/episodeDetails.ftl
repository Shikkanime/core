...
<@navigation.display canonicalUrl=canonicalUrl openGraphImage="${apiUrl}/v1/attachments?uuid=${episodeMapping.uuid}&type=image" margin=false>
        ...
        <div class="container mb-3 anime-infos">
            <div class="row g-3 mt-3">
                ...
                <div class="col-md-8 col-12 text-start mt-md-0 mt-3 d-flex flex-column justify-content-center">
                    <h1 class="h6 fw-bold mb-0 text-uppercase">${episodeMapping.anime.shortName} -
