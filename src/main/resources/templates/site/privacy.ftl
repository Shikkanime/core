...
<@navigation.display canonicalUrl="${baseUrl}/presentation">
    <div class="container mt-3">
        ...
        <p>Nous conservons vos informations personnelles pendant une période de <strong>2 ans</strong> à partir de la date de la dernière interaction avec nos services. Passé ce délai, vos données seront supprimées de manière sécurisée, sauf si une conservation plus longue est requise par la loi.</p>
