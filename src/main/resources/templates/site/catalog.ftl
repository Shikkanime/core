            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <button class="btn btn-dark dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown" aria-expanded="false">
                        <#if selectedSimulcast.season == 'WINTER'>
                        ...
                        <#elseif selectedSimulcast.season == 'AUTUMN'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-leaf-icon lucide-leaf"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/></svg>
                        <#elseif selectedSimulcast.season == 'SUMMER'>
                        ...
                        <span class="ms-2">${selectedSimulcast.label}</span>
                    </button>

                    <ul class="dropdown-menu dropdown-menu-dark" style="max-height: 300px; overflow-y: auto;">
                        <#list simulcasts as simulcast>
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="/catalog/${simulcast.slug}">
