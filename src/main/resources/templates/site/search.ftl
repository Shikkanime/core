            ...
            <div class="mt-3 p-2 shikk-element" x-data="{open: false}">
                <div class="d-flex align-items-center justify-content-center" @click="open = !open">
                    ...
                    <div class="ms-auto me-0">
                        <svg x-show="!open" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                             fill="currentColor" class="bi bi-chevron-down"
                             viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                  d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708"/>
                        </svg>
                        <svg x-show="open" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <a x-bind:href="'/animes/' + anime.slug" @mouseenter="hover = true" @mouseleave="hover = false">
                            <div class="shikk-element-content">
                                <div class="position-relative">
                                    ...
                                    <div class="platforms">
                                        <template x-for="platform in anime.platformIds.filter((platform, index, self) => self.findIndex(p => p.platform.id === platform.platform.id) === index)">
                                            <img loading="lazy" x-bind:src="'${baseUrl}/assets/img/platforms/' + platform.platform.image"
                                                 x-bind:alt="platform.platform.name"
