...
[#-- @ftlvariable name="anime" type="fr.shikkanime.dtos.animes.DetailedAnimeDto" --]
[#-- @ftlvariable name="simulcast_config" type="fr.shikkanime.platforms.configuration.PlatformSimulcast" --]
[#-- @ftlvariable name="animes" type="kotlin.collections.AbstractList<fr.shikkanime.dtos.animes.DetailedAnimeDto>" --]
